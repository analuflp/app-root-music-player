...
import com.alf.app_root_music_player.components.MiniMusicCard
    ...
    Column(
        ...
        LazyColumn(
            ...
            itemsIndexed(musics) { index, music ->
                ...
                val positionForThisCard = if (isCurrent) uiState.currentPosition else 0
                val durationForThisCard = if (isCurrent) uiState.duration else 0
                ...
                MiniMusicCard(
                    ...
                    currentPosition = positionForThisCard,
                    duration = durationForThisCard,
                    onPlayPauseClick = {
                        if (isCurrent) {
